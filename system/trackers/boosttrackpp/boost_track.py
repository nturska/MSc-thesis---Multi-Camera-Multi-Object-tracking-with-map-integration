...
from .settings import GeneralSettings, BoostTrackSettings, BoostTrackPlusPlusSettings
EmbeddingComputer = None  # ReID opcjonalny — wyłączony w naszym potoku (use_embedding=False)
